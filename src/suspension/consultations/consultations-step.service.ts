...
@Injectable()
export class SuspensionConsultationsStepService {
    ...
    async getHistories(username: string) {
        ...
        const result = await Promise.all(
            histories.map(async (history) => {
                ...
                // Fetch suspension problem with solution
